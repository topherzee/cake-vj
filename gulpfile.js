...
gulp.task("mixer-js", mixerJSInner);

gulp.task("mixer-js-watch", function () {
  // You can use a single task
  watch("./public/javascripts/src/**/*.js", mixerJSInner);
});
...
function generateMixerJade(_name) {
  ...
  jade +=
    "		link(rel='stylesheet', href='/stylesheets/compositions/" +
    _name +
    ".css')\n";
  jade += "	body \n";
  jade += "		a.logo(href='/')\n";
...
function createMixerCode(cb) {
  ...
  require("fs").writeFileSync(
    "./views/compositions/" + scaffold_name + ".pug",
    generateMixerJade(scaffold_name)
  );
  console.log("writing ", "./views/compositions/" + scaffold_name + ".pug");
  require("fs").writeFileSync(
    "./public/compositions/" + scaffold_name + ".js",
    generateMixerJs(scaffold_name)
  );
  console.log("writing ", "./public/compositions/" + scaffold_name + ".js");
  require("fs").writeFileSync(
    "./public/stylesheets/compositions/" + scaffold_name + ".sass",
    generateMixerSass(scaffold_name)
  );
  console.log(
    "writing ",
    "./public/stylesheets/compositions/" + scaffold_name + ".sass"
